 ...
 * @s1: string one
 * @s2: string two
 * @n: nr bytes to compare
 *
 * Return: 0 if the first n bytes of strings same, otherwise non-zero
 */
...
/**
 * _close - close file descriptor, print error when fails
 * @fd: descrip to close
 */
void _close(int fd)
{
...
/**
 * _read - read from a file, print error when fails
 * @fd: descrip to read
 * @buf: buffer written to
 * @count: nr bytes to read
 */
...
/**
 * elf_abivers - print ELF ABIversion
 * @buffer: ELF header
 */
 ...
 * @big_endian: endianness, if non-zero
 */
...
/**
 * main - copy one file contents to another
 * @argc: the arg count
 * @argv: the arg values
 *
 * Return: Always 0
